...
Everything written comes out of the webhook payload; the script makes no calls
to GitHub.
...
F_GITHUB_ID = "GitHub ID"
F_ORIGINAL_Q = "Link to Original Q"
F_COMPLETE = "Issue Complete?"
F_DETAILS = "Additional Details"
F_REFERENCE = "Original Record Reference"
...
def build_row(schema, existing, issue, repo_full_name, action):
    ...
    row.own(F_SOURCE, [SOURCE_GITHUB])
